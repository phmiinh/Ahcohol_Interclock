...
Khi đến hạn retest, state vào `RETEST_REQUIRED` và buzzer kêu lặp liên tục theo cùng pattern với cảnh báo FAIL. Pha buzzer được tính từ thời điểm vào `RETEST_REQUIRED`, nên sẽ có tiếng nhắc ngay khi state này bắt đầu.
...
- Có buzzer nhắc retest liên tục theo pattern FAIL.
